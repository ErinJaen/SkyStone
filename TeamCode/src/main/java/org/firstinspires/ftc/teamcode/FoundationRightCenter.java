...
public class FoundationRightCenter extends OpMode {
    ...
    timeState towardCenter;
    driveState strafeToLine;
    ...
    public void init() {
        ...
        forwardsFoundation1 = new timeState(4000,  .5, motors, "backward");
        raiseClamp = new oneServo(1000, .7, mrClamp);
        strafeRight = new driveState(40,.5,motors,"strafeLeft");
        towardCenter = new timeState(2500, .4, motors, "forward");
        strafeToLine = new driveState(10, .5, motors, "strafeLeft");
        ...
        strafeRight.setNextState(towardCenter);
        towardCenter.setNextState(strafeToLine);
