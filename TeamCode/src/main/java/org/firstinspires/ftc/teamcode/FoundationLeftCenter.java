...
public class FoundationLeftCenter extends OpMode {
    ...
    public void init() {
        ...
        strafeRight = new driveState(40,.5,motors,"strafeRight");
        towardsCenter = new timeState(2500, .4, motors, "forward");
        strafeRightAgain = new driveState(10, .5, motors, "strafeRight");
        ...
        strafeRight.setNextState(towardsCenter);
        towardsCenter.setNextState(strafeRightAgain);
        strafeRightAgain.setNextState(turnLeft);
